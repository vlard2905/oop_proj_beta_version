...
/**
 * Class for looking through the list of members.
 * @see ControllerEditCompany
 */
public class ControllerEditCompany implements Serializable, Initializable, MenuBarInterface {
    @Override
    ...
    private FileInputStream userD = null;
